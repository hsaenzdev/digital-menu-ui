          ...
          <AuthProvider>
            <div className="min-h-screen w-full bg-white">
              <Routes>
                ...
                />
                <Route
                  path="/:customerId/order-confirmation"
                  element={
                    <CustomerGuard>
                ...
                />
                <Route
                  path="/:customerId/payment-pending/:orderId"
                  element={
                    <CustomerGuard>
                      <PaymentPendingPage />
                    </CustomerGuard>
                ...
                />
                <Route
                  path="/:customerId/order-status/:orderId"
                  element={
                    <CustomerGuard>
                      <OrderStatusPage />
                    </CustomerGuard>
                ...
                <Route
                  path="/:customerId/error/customer-disabled"
                  element={<CustomerDisabledPage />}
                />
                <Route
                  path="/:customerId/error/restaurant-closed"
                  element={<RestaurantClosedPage />}
                />
                <Route
                  path="/:customerId/error/outside-city"
                  element={<OutsideCityPage />}
                />
                <Route
                  path="/:customerId/error/outside-zone"
                  element={<OutsideZonePage />}
                />
                <Route
                  path="/:customerId/error/no-location-permission"
                  element={<NoLocationPermissionPage />}
                />
                <Route
                  path="/:customerId/error/no-geolocation-support"
                  element={<NoGeolocationSupportPage />}
                />
                <Route
                  path="/:customerId/error/generic"
                      ...
                      <div className="flex-1 flex items-center justify-center">
                        <div className="text-center max-w-md">
                          ...
                          <p className="text-white/90 text-lg mb-6 drop-shadow">
                            This link is not valid. Please use the personalized
                            link sent to you.
                          </p>
