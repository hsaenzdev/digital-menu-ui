...
export const OutsideCityPage: React.FC = () => {
  ...
  const cityName = "";
  const message = "We don't currently operate in your city.";

  return (
    <div className="h-screen-dvh flex flex-col bg-gradient-to-br from-amber-500 via-orange-600 to-red-600 overflow-hidden p-6">
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center max-w-md w-full">
          ...
          <p className="text-white/90 text-lg mb-6 drop-shadow">{message}</p>
