...
export const PaymentPendingPage: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="h-screen flex flex-col bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 overflow-hidden">
  ...
  if (error || !order || !bankSettings) {
    return (
      <div className="h-screen flex flex-col bg-gradient-to-br from-red-500 via-red-600 to-rose-600 overflow-hidden">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-blue-50 rounded-lg p-3">
                ...
                <div className="flex items-center justify-between gap-2">
                  <span className="font-bold text-gray-900">{bankSettings.bankName}</span>
                  <button
              ...
              <div className="bg-blue-50 rounded-lg p-3">
                ...
                <div className="flex items-center justify-between gap-2">
                  <span className="font-bold text-gray-900 text-lg">{bankSettings.bankAccountNumber}</span>
                  <button
                    onClick={() => copyToClipboard(bankSettings.bankAccountNumber, 'accountNumber')}
                    className="text-blue-600 hover:text-blue-700 p-2"
                    title="Copy"
                  >
                    <FontAwesomeIcon icon={faCopy} />
              ...
              <div className="bg-blue-50 rounded-lg p-3">
                ...
                <div className="flex items-center justify-between gap-2">
                  <span className="font-bold text-gray-900">{bankSettings.bankAccountHolder}</span>
                  <button
                    onClick={() => copyToClipboard(bankSettings.bankAccountHolder, 'accountHolder')}
                    className="text-blue-600 hover:text-blue-700 p-2"
                    title="Copy"
                  >
                    <FontAwesomeIcon icon={faCopy} />
              ...
              <div className="bg-amber-50 rounded-lg p-3 border-2 border-amber-300">
                ...
                <div className="flex items-center justify-between gap-2">
                  <span className="font-bold text-amber-900 text-xl font-mono">{order.transferReference}</span>
                  <button
                    onClick={() => copyToClipboard(order.transferReference || '', 'reference')}
          ...
          <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl p-4 border-2 border-orange-300 shadow-md">
            ...
            <div className="space-y-2.5 text-sm text-gray-800">
              <div className="flex gap-2">
                ...
                <p><span className="font-semibold">Open your banking app</span> or visit your bank</p>
              </div>
              <div className="flex gap-2">
                <span className="font-bold text-orange-600">2.</span>
                <p><span className="font-semibold">Make a transfer</span> to the account details above</p>
              </div>
              <div className="flex gap-2">
                <span className="font-bold text-orange-600">3.</span>
                <p><span className="font-semibold">Use the reference number</span> <span className="font-mono bg-amber-100 px-2 py-0.5 rounded">{order.transferReference}</span> in your transfer</p>
              </div>
              <div className="flex gap-2">
                <span className="font-bold text-orange-600">4.</span>
                <p><span className="font-semibold">Transfer exactly</span> ${order.total.toFixed(2)}</p>
              </div>
              <div className="flex gap-2">
                <span className="font-bold text-orange-600">5.</span>
                <p><span className="font-semibold">Wait here</span> - We'll confirm within 15 minutes during business hours</p>
              </div>
            </div>
            
            {bankSettings.bankTransferInstructions && (
              <div className="mt-3 pt-3 border-t border-orange-200">
                <p className="text-xs text-gray-700">{bankSettings.bankTransferInstructions}</p>
              </div>
            )}
          </div>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="bg-amber-50 border-2 border-amber-300 rounded-lg p-4">
                  ...
                  <p className="text-sm text-amber-800">
                    If you have already made the bank transfer, we will refund your money. However, the refund process might take time depending on your bank's processing schedule.
                  </p>
                </div>

                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <p className="text-xs text-blue-800">
                    💡 <span className="font-semibold">Tip:</span> If you haven't transferred yet, you can simply cancel. If you have transferred, please keep your receipt for the refund process.
                  </p>
                </div>
              </div>
